window['relay-translation-es'] = {
  ...
  "dkim_configuration_help_subtitle": "Aquí tienes los datos necesarios para sumar el valor TXT en tus registros DNS. Recuerda que la configuración del DKIM es un paso obligado para comenzar enviar vía Doppler Relay.",
  ...
  "dkim_configuration_help_spf_subtitle": "Incluye el SPF de Doppler Relay para evitar la falsificación de direcciones de tu remitente. A continuación encontrarás información del campo SPF.",
  ...
  "domain_manager_remember_hours_tracking_domain_update": "Recuerda que puede tardar hasta 24 horas en actualizarse el status del Seguimiento de Dominio.",
  ...
  "tracking_domain_not_ready_header_text": "Añade un registro CNAME en los registros DNS de tu dominio para poder comenzar a utilizar tu cuenta.",
  "tracking_domain_not_ready_header_button" : "Aprende cómo hacerlo aquí",
