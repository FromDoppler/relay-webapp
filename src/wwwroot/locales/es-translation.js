window['relay-translation-es'] = {
  ...
  "validation_error_accountname_invalid": "El nombre de cuenta solo puede contener letras (A–Z, a–z), números (0–9), guiones (-) y guiones bajos (_), y debe incluir al menos una letra.",
