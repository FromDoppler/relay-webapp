window['relay-translation-es'] = {
  ...
  "otp_resend_code": "Reenviar código",
  "otp_validation_title_signup": "Valida tu cuenta",
  "otp_validation_title_login": "Verifica tu identidad",
  "otp_validation_subtitle_signup": "Por favor ingresa el código que enviamos a tu correo",
  "otp_validation_subtitle_login": "Ingresa el código de tu aplicación de autenticación",
  "otp_validation_code_label": "Código:",
  "otp_resend_succeed": "¡Te enviamos un nuevo código!",
  "otp_error_code_incorrect": "El código es incorrecto.",
  "otp_error_code_expired": "El código ha expirado, por favor solicita uno nuevo.",
  "otp_error_code_general": "Hubo un error al verificar el código. Por favor intenta nuevamente.",
  "otp_error_code_resend_error": "No pudimos reenviar el código. Por favor intenta nuevamente más tarde.",
  "otp_verify_button": "Verificar",
  ...
  "resubscribe_label_reason_input": "Motivo:",
  "resubscribe_input_button": "REACTIVAR",
  ...
  "connection-settings_request_api_key": "Solicitar API key",
  "connection-settings_reset_api_key": "Restablecer API key",
  "connection-settings_reset_api_key_popup_title": "¿Estás seguro de que quieres restablecer tu API Key?",
  "connection-settings_reset_api_key_popup_desc": "Tu API Key actual será desactivada y se generará una nueva API Key, que será enviada a tu correo electrónico. Asegúrate de tener acceso a tu bandeja de entrada para recibirla.",
  "connection-settings_api_key_sent_succefully": "Tu API Key ha sido enviada a tu correo electrónico. Por favor, revisa tu bandeja de entrada y asegúrate de haber recibido el correo.",
  "connection-settings_api_key_sent_failed": "Lo sentimos, se ha producido un error en el envío de tu API Key. Por favor, contacta con nuestro equipo de soporte para resolver este inconveniente. ",
  "connection-settings_api_key_sent_failed_contact": "CONTACTAR",
  ...
  "registration_pass_label_2": "Confirmar Contraseña",
  ...
  "dkim_configuration_help_domain_title": "Encuentra aquí toda la información necesaria (DKIM, DMARC, SPF, Subdominio) para actualizar tus registros DNS y verificar que eres un remitente autorizado para este dominio. Si no sabes cómo hacerlo",
  ...
  "dkim_configuration_help_dmarc_title": "DMARC",
  "dkim_configuration_help_dmarc_subtitle": "Aquí tienes los datos necesarios para sumar el valor TXT en tus registros DNS. Recuerda que la configuración de DMARC es un paso obligado para comenzar enviar vía {{ companyName }}.",
  "dkim_configuration_help_dmarc_record_name_title": "Registro DMARC:",
  "dkim_configuration_help_dmarc_record_name_text": "_dmarc.{{ domain }}",
  "dkim_configuration_help_dmarc_record_value_title": "Valor Registro DMARC:",
  "dkim_configuration_help_dmarc_record_value_text": "v=DMARC1; p=none; rua=mailto:dmarc-reports@{{ domain }}",
  "dkim_configuration_help_dmarc_subtitle_link_href": "es/como-configurar-tu-dkim-paso-a-paso#dmarc",
  "dkim_configuration_help_dmarc_subtitle_link": "Aquí puedes encontrar ayuda para configurar el DMARC.",
  "resubscribe": "Reactivar Suscriptores",
  ...
  "domain_manager_dkim_status_th": "DKIM",
  "domain_manager_spf_status_th": "SPF",
  "domain_manager_dmarc_status_th": "DMARC",
  ...
  "domain_manager_dmarc_status_error_tooltip": "El DMARC no está configurado aún.",
  ...
  "change_password_invalid_format": "La nueva contraseña no cumple con los requisitos.",
  "change_password_pwned": "Esta contraseña ha sido encontrada en una filtración de datos. Por favor elige una contraseña diferente.",
  "change_password_too_long": "La contraseña es demasiado larga.",
  "change_password_too_short": "La contraseña es demasiado corta. Por favor usa al menos 8 caracteres.",
  "change_password_not_strong_enough": "La contraseña no es lo suficientemente fuerte. Por favor usa una contraseña más segura.",
  "change_password_missing_lowercase": "La contraseña debe contener al menos una letra minúscula.",
  "change_password_missing_uppercase": "La contraseña debe contener al menos una letra mayúscula.",
  "change_password_missing_number": "La contraseña debe contener al menos un número.",
  "change_password_missing_special_char": "La contraseña debe contener al menos un carácter especial.",
  "change_password_matches_current": "La nueva contraseña no puede ser igual a tu contraseña actual.",
  "change_password_error": "Ocurrió un error al actualizar tu contraseña. Por favor intenta nuevamente.",
  "change_password_db_error": "Contraseña actualizada en el sistema de autenticación pero falló la sincronización con la base de datos. Por favor contacta a soporte.",
  "my_profile_change_email_success": "Tu email ha sido cambiado exitosamente.",
  "change_email_otp_subtitle": "Hemos enviado un código de verificación a tu nueva dirección de email. Por favor ingrésalo a continuación.",
  ...
  "two_factor_required_for_action": "Para efectuar la acción de forma segura, primero tienes que activar la autenticación en dos pasos. Hazlo desde Administrar Cuenta > Seguridad.",
  "user_text": "Usuario",
  "plans_text": "Mi Plan",
  ...
  "eprotect_placeholder_credit_card": "Número de tarjeta",
  "eprotect_label_account_number": "Número de tarjeta",
  "eprotect_label_exp_date": "Vencimiento",
  "eprotect_label_cvv": "Código de seguridad",
  "eprotect_error_cvv_invalid": "¡Ouch! Código de seguridad inválido, por favor revisa el dato ingresado.",
  "eprotect_error_expired_paypage_registration_id": "¡Ouch! La sesión de pago expiró, por favor actualiza la página e intenta nuevamente.",
  "eprotect_error_merchant_not_authorized": "¡Ouch! No podemos procesar pagos en este momento, por favor intenta más tarde.",
  "eprotect_error_payframe_failed_to_load": "¡Ouch! No se pudo cargar el formulario de pago, por favor actualiza la página e intenta nuevamente.",
  "eprotect_error_unable_to_encrypt_field": "¡Ouch! No se pudo procesar la información de tu tarjeta, por favor intenta nuevamente.",
  "eprotect_error_invalid_credit_card_number": "El número de tarjeta ingresado no es válido.",
  "eprotect_error_invalid_expiration_date": "La fecha de vencimiento ingresada no es válida.",
  "eprotect_error_declined": "El pago fue rechazado por la entidad emisora de la tarjeta.",
  "eprotect_error_generic": "No pudimos procesar el pago, por favor revisa tu información.",
  ...
  "domain_manager_remember_hours_dmarc_update": "Recuerda que puede tardar hasta 24 horas en actualizarse el estado del DMARC.",
  ...
  "submenu_my_billing_information":"Información de facturación",
  "my_billing_information_text": "Información de facturación",
  "my_billing_information_subtitle": "El servicio se cobrará a la tarjeta de crédito que figura aquí. Si lo deseas puedes <b>cambiar la tarjeta.</b>",
  "my_billing_information_change_credit_card": "Cambiar tarjeta",
  "my_billing_information_back_button": "Atrás",
  "my_billing_information_save_button": "Guardar",
  "my_billing_information_payment_method_title": "Medio de Pago",
  "my_billing_information_credit_card_option": "Tarjeta de Crédito",
  "my_billing_information_card_holder_label": "Titular",
  "my_billing_information_card_number_label": "Número de tarjeta",
  "my_billing_information_exp_date_label": "Vencimiento",
  "my_billing_information_sec_code_label": "Código de seguridad",
  "my_billing_information_success_close_button": "Cerrar",
