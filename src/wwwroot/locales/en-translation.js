window['relay-translation-en'] = {
  ...
  "otp_resend_code": "Send me the code again",
  "otp_validation_title_signup": "Verify your account",
  "otp_validation_title_login": "Verify your identity",
  "otp_validation_subtitle_signup": "Please enter the code we sent to your email",
  "otp_validation_subtitle_login": "Enter the code from your authenticator app",
  "otp_validation_code_label": "Code:",
  "otp_resend_succeed": "We've sent you a new code!",
  "otp_error_code_incorrect": "The code is incorrect.",
  "otp_error_code_expired": "The code has expired, please request a new one.",
  "otp_error_code_general": "There was an error verifying the code. Please try again.",
  "otp_error_code_resend_error": "We couldn't resend the code. Please try again later.",
  ...
  "resubscribe": "Reactivate Subscribers",
  "resubscribe_label_email_input": "Email address:",
  ...
  "connection-settings_request_api_key": "Request API key",
  "connection-settings_reset_api_key": "Reset API key",
  "connection-settings_reset_api_key_popup_title": "Are you sure you want to reset your API Key?",
  "connection-settings_reset_api_key_popup_desc": "Your current API Key will be deactivated, and a new API Key will be generated and sent to your email. Make sure you have access to your inbox to receive it.",
  "connection-settings_api_key_sent_succefully": "Your API Key has been sent to your email. Please check your inbox and make sure you have received the email.",
  "connection-settings_api_key_sent_failed": "We're sorry, an error occurred while sending your API Key. Please contact our support team to resolve this issue. ",
  "connection-settings_api_key_sent_failed_contact": "CONTACT",
  ...
  "registration_pass_label_2": "Confirm Password",
  ...
  "dkim_configuration_help_domain_title": "Find here all the necessary information (DKIM, DMARC, SPF, Subdomain) to update your DNS records and verify that you are an authorized sender for this domain. If you do not know how to do it,",
  ...
  "dkim_configuration_help_dmarc_subtitle": "Find here you have the necessary data to add the TXT value in your DNS records. Remember that the DMARC configuration is a required step to start sending via {{ companyName }}.",
  "dkim_configuration_help_dmarc_record_name_title": "DMARC Record Name:",
  "dkim_configuration_help_dmarc_record_name_text": "_dmarc.{{ domain }}",
  "dkim_configuration_help_dmarc_record_value_title": "DMARC Record Value:",
  "dkim_configuration_help_dmarc_record_value_text": "v=DMARC1; p=none; rua=mailto:dmarc-reports@{{ domain }}",
  "dkim_configuration_help_dmarc_subtitle_link_href": "en/how-to-configure-your-dkim-step-by-step#dmarc",
  "dkim_configuration_help_dmarc_subtitle_link": "Find here some help to configure the DMARC.",
  ...
  "domain_manager_dmarc_status_error_tooltip": "The DMARC is not configured yet.",
  ...
  "change_password_invalid_format": "The new password does not meet the requirements.",
  "change_password_pwned": "This password has been found in a data breach. Please choose a different password.",
  "change_password_too_long": "The password is too long.",
  "change_password_too_short": "The password is too short. Please use at least 8 characters.",
  "change_password_not_strong_enough": "The password is not strong enough. Please use a stronger password.",
  "change_password_missing_lowercase": "The password must contain at least one lowercase letter.",
  "change_password_missing_uppercase": "The password must contain at least one uppercase letter.",
  "change_password_missing_number": "The password must contain at least one number.",
  "change_password_missing_special_char": "The password must contain at least one special character.",
  "change_password_matches_current": "The new password cannot be the same as your current password.",
  "change_password_error": "An error occurred while updating your password. Please try again.",
  "change_password_db_error": "Password updated in authentication system but failed to sync with database. Please contact support.",
  "my_profile_change_email_success": "Your email has been successfully changed.",
  "change_email_otp_subtitle": "We've sent a verification code to your new email address. Please enter it below.",
  ...
  "eprotect_placeholder_credit_card": "Card number",
  "eprotect_label_account_number": "Card number",
  "eprotect_label_exp_date": "Expiration",
  "eprotect_label_cvv": "Security code",
  "eprotect_error_cvv_invalid": "Oops! Invalid security code, please check the entered value.",
  "eprotect_error_expired_paypage_registration_id": "Oops! Your payment session expired, please refresh the page and try again.",
  "eprotect_error_merchant_not_authorized": "Oops! We can't process payments right now, please try again later.",
  "eprotect_error_payframe_failed_to_load": "Oops! The payment form couldn't be loaded, please refresh the page and try again.",
  "eprotect_error_unable_to_encrypt_field": "Oops! We couldn't process your card information, please try again.",
  "eprotect_error_invalid_credit_card_number": "The credit card number entered is not valid.",
  "eprotect_error_invalid_expiration_date": "The expiration date entered is not valid.",
  "eprotect_error_declined": "The payment was declined by the card issuer.",
  "eprotect_error_generic": "We couldn't process the payment, please check your information.",
  ...
  "domain_manager_remember_hours_dmarc_update": "Remember that the DMARC status can take up to 24 hours to update.",
  ...
  "resubscribe_internal_policies_error": "Get in touch with our Customer Support team.",
